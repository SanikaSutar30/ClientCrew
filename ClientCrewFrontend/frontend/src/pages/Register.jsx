...
const Register = () => {
  ...
  const [showAccountCreationSuccess, setShowAccountCreationSuccess] =
    useState(false);
  ...
  return (
    <div className="min-h-screen bg-[#eef2f7]">
          ...
          <div className="relative z-10 flex flex-col justify-between w-full max-w-xl">
            <div>
              ...
              <h2 className="text-[42px] font-bold leading-tight">
                Join your all-in-one workspace
              </h2>

              <p className="mt-4 text-base text-white/85 leading-7 max-w-lg">
                Create your ClientCrew account and start managing customers,
                projects, tasks, and team communication in one place.
              </p>
          ...
          <div className="w-full max-w-[520px]">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-200">
              <div className="text-center mb-5">
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Set up your workspace access and get started
                </p>
              </div>
      ...
      <ConfirmationModal
        isOpen={showAccountCreationSuccess}
        darkMode={false}
        type="success"
